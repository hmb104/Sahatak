...
class EmailService:
    ...
    def send_email_confirmation(
        ...
        try:
            ...
            verification_url = f"{current_app.config.get('FRONTEND_URL', 'https://hmb104.github.io/Sahatak')}/frontend/pages/verify-email.html?token={user_data['verification_token']}"
